...
const generateRandomNum = () => {
  ...
  describe('/verifyPassword', () => {
    it('should return true if encrypted password and password match', () => {
      const mockPass = 'realuser123';
    ...
    it('should return false if encrypted password and password not match', () => {
      const mockPass = 'realuser123';
      const mockHass = bcrypt.hashSync(mockPass + 101, 10);
  ...
  describe('/createTokenFromUser', () => {
    it('should return jwt token based on user and role.', () => {
      const roleModel = Role;
      const userModel = User;
      const controller = new AuthenticationController({
        userModel, roleModel, bcrypt, jwt,
  ...
  describe('/handleRegister', () => {
    it('should return res.status(201) and token',
        async () => {
          const mockReq = {
            body: {
              name: mockUser.name,
    ...
    it('should return res.status(422) and err instance',
        async () => {
          const mockReq = {
            body: {
              name: mockUser.name,
    ...
    it('should go to next function to handle error.',
        async () => {
          const mockReq = {
            body: {
              name: mockUser.name,
  ...
  describe('/handleLogin', () => {
    it('should res.status(201) and return access token',
        async () => {
          const mockReq = {
            body: {
              email: mockUser.email,
  ...
  describe('authorize', () => {
    ...
    it('should res.status(401) with error instance if token wrong.',
        async () => {
          ...
          const mockReq = {
            headers: {
              authorization: 'Bearer ' + mockToken + '123',
            },
          };
          const mockRes = {
            status: jest.fn().mockReturnThis(),
